...
CREATE TABLE plataforma.processo_workflow (num_process_instance bigint not null, dsc_status_process_instance varchar2(50) not null, primary key (num_process_instance));
