...
(function() {
	...
	angular.autuacao.controller('PeticionamentoController', function (data, $scope, $state, messages, properties, $log, $window,PeticaoService, FileUploader, PecaService, OrgaoService) {
		...
		$scope.finalizar = function() {
			...
			var command = new PeticionarCommand($scope.classe, $scope.orgao, $scope.partesPoloAtivo, $scope.partesPoloPassivo, $scope.pecas);
    	...
    	function PeticionarCommand(classe, orgao, partesPoloAtivo, partesPoloPassivo, pecas){
    		var dto = {};
    		dto.classeId = classe;
    		dto.orgaoId = orgao;
    		dto.partesPoloAtivo = [];
