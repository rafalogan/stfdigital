...
if(substr($sPage, 0, 7 ) === "plugins") {
    ...
    $scripts = '
    <!-- tablesorter -->
    <script src="'.$bower_url.'/jquery.tablesorter/dist/js/jquery.tablesorter'.$dist_min.'.js"></script>
    <script src="'.$bower_url.'/jquery.tablesorter/dist/js/jquery.tablesorter.widgets.min.js"></script>
    <script src="'.$bower_url.'/jquery.tablesorter/dist/js/widgets/widget-alignChar.min.js"></script>
    <script src="'.$bower_url.'/jquery.tablesorter/addons/pager/jquery.tablesorter.pager.js"></script>
